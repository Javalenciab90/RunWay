...
import com.java90.runway.other.Constants.ACTION_SHOW_TRACKING_FRAGMENT
...
import com.java90.runway.other.Constants.FASTEST_LOCATION_INTERVAL
import com.java90.runway.other.Constants.LOCATION_UPDATE_INTERVAL
...
class TrackingService() : LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        // Remove action preview to set the new
